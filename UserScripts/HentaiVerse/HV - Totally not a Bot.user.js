    ...
    */
    ...
    Fight: {
        ...
        Debuff: {
            ...
            MinMana: 25,
            DebuffsToUse: ["Weaken", "Imperil"] //, "Slow"
        },
...
window.Bot = {
        ...
        Advance: function () {
            if (this.AdvanceOnVictory) {
                if ($$("#pane_completion #btcp")) {
                    if ($$("#btcp").onclick.toString().indexOf("battle.battle_continue()") > -1) {
                ...
                if (this.Active && this.BuffsToUse && this.BuffsToUse.length > 0)
                    for (let i = 0; i < this.BuffsToUse.length; i++)
                        if (!In(this.ListOfBuffsOn, this.BuffsToUse[i]))
                            if (Bot.UseSpell(this.BuffsToUse[i]))
                                return true;
                    ...
                    for (let i = 0; i < monsterList.length; i++) {
                        ...
                        for (let j = 0; j < this.DebuffsToUse.length; j++) {
                            if (!In(listOfDebuffsOn, this.DebuffsToUse[j])) {
                                if (Bot.UseSpell(this.DebuffsToUse[j])) {
                                    monsterList[i].click();
                                    return true;
                                }
                            }
    ...
    Riddle: Object.assign(BotConfig.Riddle, {
        Start: function () {
            if (this.Active && $("#riddlemaster").length > 0) {
                ...
                if (answer != null) {
                    localStorage.lastRiddleAnswer = "Your ass has been saved by the all mighty god. Answer: " + answer;
                    console.log(localStorage.lastRiddleAnswer);
        ...
        Combinations: {
            ...
            "9a585d1555": "B", "06b7fce8e3": "B", "284e31f095": "B", "3469f0a205": "B", "1f5ab6f560": "B", "a7d8cc63ed": "B", "ec992e36b2": "B",
            ...
            "359872d4e2": "C", "359872d4e2": "C", "fa8bd05562": "C",
        }
    }),
    Arena: Object.assign(BotConfig.Arena, {
        Start: function () {
